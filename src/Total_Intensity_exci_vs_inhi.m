function Total_Intensity_exci_vs_inhi(dataStruct, distinguish_cells)
...
scatter( inhI_excI_branchL(:,1), inhI_excI_branchL(:,2), 'filled')
for b = 1:Nbranches
    text( inhI_excI_branchL(b,1), inhI_excI_branchL(b,2), ['B',num2str(b)] );
end
hold on
...
xlabel('Total inhib. intensities'); 
ylabel('Total exci. intensities');
