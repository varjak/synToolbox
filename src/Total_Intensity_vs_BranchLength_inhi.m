function Total_Intensity_vs_BranchLength_inhi(dataStruct, distinguish_cells)
...
scatter( inhI_excI_branchL(:,1), inhI_excI_branchL(:,3), 'filled')
for b = 1:Nbranches
    t = text( inhI_excI_branchL(b,1), inhI_excI_branchL(b,3), ['B',num2str(b)] );
    t.FontSize = 7;
end
hold on
